...
//                 body { font-family: "Tajawal", "Cairo", system-ui, sans-serif; background-color: var(--color-bg); color: var(--color-text); line-height: 1.7; direction: rtl; }

//                 .packages-page { min-height: 100vh; display: flex; flex-direction: column; }

//                 .main-header { background-color: #ffffff; border-bottom: 2px solid rgba(118, 73, 156, 0.15); position: sticky; top: 0; z-index: 10; box-shadow: 0 4px 10px rgba(0,0,0,0.05); }

//                 .nav-container { display: flex; align-items: center; justify-content: space-between; padding: 1.3rem 0; width: 90%; max-width: 1100px; margin: 0 auto; }
//                 .logo { display: flex; align-items: center; gap: 1rem; }
//                 .logo-img { height: 85px; width: auto; }
//                 .logo-text-wrap { display: flex; flex-direction: column; }
//                 .logo-text-ar-big { font-size: 2rem; font-weight: 800; color: var(--color-primary); line-height: 1.2; }
//                 .logo-text-sub { font-size: 1.05rem; color: var(--color-teal); }
//                 .main-nav { display: flex; align-items: center; gap: 1.5rem; }
//                 .main-nav a { text-decoration: none; color: #333; font-size: 1.15rem; font-weight: 600; transition: color 0.3s ease; }
//                 .main-nav a:hover { color: var(--color-primary); }
//                 .main-nav a.active { color: var(--color-primary); border-bottom: 3px solid var(--color-teal); padding-bottom: 0.3rem; }

//                 .user-menu { position: relative; }
//                 .user-button { display: inline-flex; align-items: center; padding: 0.5rem 1rem; border-radius: 999px; background-color: var(--color-primary); color: white; font-size: 1rem; font-weight: 600; border: none; cursor: pointer; transition: opacity 0.3s ease; }
//                 .user-button:hover { opacity: 0.9; }
//                 .user-button svg { margin-right: 0.5rem; width: 1rem; height: 1rem; }
//                 .dropdown-menu { position: absolute; left: 0; top: 100%; margin-top: 0.5rem; background-color: white; border-radius: 0.7rem; box-shadow: 0 10px 25px rgba(0,0,0,0.1); min-width: 200px; overflow: hidden; z-index: 50; }
//                 .dropdown-item { display: block; padding: 0.75rem 1rem; color: #333; text-decoration: none; transition: background-color 0.2s ease; font-size: 0.95rem; }
//                 .dropdown-item:hover { background-color: rgba(118, 73, 156, 0.08); }

//                 .section { padding: 2.5rem 0; flex: 1; }
//                 .container { width: 90%; max-width: 1100px; margin: 0 auto; }
//                 .section-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 2rem; }
//                 .section-title { font-size: 1.7rem; color: var(--color-primary); font-weight: 700; }

//                 .btn { display: inline-block; padding: 0.7rem 1.3rem; border-radius: 999px; text-decoration: none; font-size: 1rem; border: 1px solid transparent; transition: all 0.25s ease; font-weight: 600; }
//                 .btn-primary { background-color: var(--color-primary); color: #fff; }
//                 .btn-primary:hover { opacity: 0.95; }

//                 .packages-grid { display: grid; grid-template-columns: repeat(auto-fill, minmax(280px, 1fr)); gap: 1.5rem; }
//                 .package-card { background-color: #fff; border-radius: 1rem; box-shadow: 0 6px 18px rgba(0,0,0,0.04); overflow: hidden; transition: transform 0.2s ease, box-shadow 0.2s ease; }
//                 .package-card:hover { transform: translateY(-3px); box-shadow: 0 8px 20px rgba(0,0,0,0.08); }
//                 .package-image { width: 100%; height: 200px; object-fit: cover; }
//                 .package-content { padding: 1.4rem; }
//                 .package-title { font-size: 1.25rem; font-weight: 700; color: var(--color-primary); margin-bottom: 0.5rem; }
//                 .package-description { font-size: 0.95rem; color: #444; line-height: 1.7; margin-bottom: 1rem; }
//                 .package-actions { display: flex; flex-direction: column; gap: 0.5rem; }

//                 .btn-request { background-color: var(--color-teal); color: #fff; padding: 0.7rem 1rem; border-radius: 999px; border: none; font-size: 1rem; font-weight: 600; cursor: pointer; transition: opacity 0.3s ease; text-align: center; }
//                 .btn-request:hover { opacity: 0.9; }

//                 .btn-edit { background-color: var(--color-yellow); color: #333; padding: 0.6rem 1rem; border-radius: 999px; border: none; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: opacity 0.3s ease; text-align: center; text-decoration: none; }
//                 .btn-edit:hover { opacity: 0.9; }

//                 .btn-delete { background-color: #c62828; color: #fff; padding: 0.6rem 1rem; border-radius: 999px; border: none; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: background-color 0.3s ease; text-align: center; }
//                 .btn-delete:hover { background-color: #a01515; }

//                 .main-footer { background-color: #3a0d63; color: #f3e9ff; padding: 1rem 0; margin-top: 0.5rem; font-size: 0.95rem; }
//                 .footer-container { display: flex; align-items: center; justify-content: space-between; gap: 1rem; width: 90%; max-width: 1100px; margin: 0 auto; }
//                 .footer-links { display: flex; align-items: center; gap: 0.5rem; }
//                 .footer-links a { color: #e0cffc; text-decoration: none; }
...
//                     .logo-text-ar-big { font-size: 1.3rem; }
        ...
        <>
            ...
            <style>{`
                ...
                * { margin: 0; padding: 0; box-sizing: border-box; }
                ...
                .btn-edit { background-color: var(--color-yellow); color: #333; padding: 0.6rem 1rem; border-radius: 999px; border: none; font-size: 0.95rem; font-weight: 600; cursor: pointer; transition: opacity 0.3s ease; text-align: center; text-decoration: none; display: block; }
                .btn-edit:hover { opacity: 0.9; }
