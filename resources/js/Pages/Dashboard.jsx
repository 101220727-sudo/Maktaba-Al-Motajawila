...
//     const user = auth?.user; // Safely get the logged-in user

//     return (
//         <AuthenticatedLayout
//             auth={auth} // pass auth to layout if needed
//             header={
...
//                                 {/* Add News - only visible for admin_news */}
//                                 {user?.role?.name === 'admin_news' && (
//     <Link
//         href={route('news.add')}
