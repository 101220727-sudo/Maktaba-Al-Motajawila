...
// }
    ...
    //     DB::table('events_package')->insert([
...
//         'total_price'   => 'required|numeric',
//         'event_time'    => 'required',
//         'activity_ids'  => 'required|array',          // expect array of activity IDs
//         'activity_ids.*'=> 'integer|exists:activities,id', // each ID must exist
//     ]);

//     // Insert package (without activity_id)
